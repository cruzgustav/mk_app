...
export default function Home() {
  return (
    <div className="min-h-[100dvh] sm:min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 flex flex-col items-center sm:justify-center sm:p-4 pb-[env(safe-area-inset-bottom)] overflow-x-hidden">
      <FaceAnalysisWidget />
